...
- [`GEOMETRY_BELT_PULLEY_HELPER_PLAN.md`](./GEOMETRY_BELT_PULLEY_HELPER_PLAN.md) — implementation-facing v0 plan for a first bounded open-belt helper (`openBeltPath`) built from external common tangents and existing circular arc path commands.
