...
| Path primitive (v1: moveTo/lineTo/quadraticCurveTo/cubicCurveTo/closePath) | [packages/geometry/src/geometry.test.ts](../packages/geometry/src/geometry.test.ts) | [packages/resolver/src/resolveScene.test.ts](../packages/resolver/src/resolveScene.test.ts) | `path-primitive`, `bezier-path` | Yes | Path bbox/anchors are bbox-derived from explicit path points; the first Bezier slice uses conservative control-point bbox behavior and renders SVG `<path>` with `M/L/Q/C/Z` commands. |
