...
The `alignment-reference` example remains a reference fixture for ongoing alignment and future distribution work. `alignLeft`, `alignRight`, `alignTop`, `alignBottom`, `alignX`, and `alignY` are implemented, while distribution remains future work in [`docs/ALIGNMENT_DESIGN.md`](./ALIGNMENT_DESIGN.md).