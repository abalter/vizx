...
| `rightOf` placement | [packages/examples/src/index.test.ts](../packages/examples/src/index.test.ts) | [packages/resolver/src/resolveScene.test.ts](../packages/resolver/src/resolveScene.test.ts) | `basic`, `relative-placement` | Indirect | Aligns target `west` to the right of reference `east` by the requested gap. |
| `leftOf` placement | [packages/examples/src/index.test.ts](../packages/examples/src/index.test.ts) | [packages/resolver/src/resolveScene.test.ts](../packages/resolver/src/resolveScene.test.ts) | `relative-placement` | Indirect | Aligns target `east` to the left of reference `west` by the requested gap. |
| `above` placement | [packages/examples/src/index.test.ts](../packages/examples/src/index.test.ts) | [packages/resolver/src/resolveScene.test.ts](../packages/resolver/src/resolveScene.test.ts) | `relative-placement` | Indirect | Uses SVG-style downward-positive Y, so `above` subtracts the gap from the reference `north`. |
| `below` placement | [packages/examples/src/index.test.ts](../packages/examples/src/index.test.ts) | [packages/resolver/src/resolveScene.test.ts](../packages/resolver/src/resolveScene.test.ts) | `relative-placement` | Indirect | Uses SVG-style downward-positive Y, so `below` adds the gap to the reference `south`. |
