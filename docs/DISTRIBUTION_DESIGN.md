...
The first distribution model is implemented.

- `distributeX`: implemented
- `distributeY`: implemented
...
The initial center-based distribution family (`distributeX` and `distributeY`) is complete.
