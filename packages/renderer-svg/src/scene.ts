...
export type RenderNode = RenderGroup | RenderRect | RenderCircle | RenderEllipse | RenderLine | RenderPolyline | RenderPolygon | RenderPath | RenderText;
...
export interface RenderPolygon extends BaseRenderNode {
